...
if ( function_exists( 'register_block_pattern_category' ) ) {
	register_block_pattern_category(
		'blog',
		array( 'label' => esc_html__( 'Blog / post list', 'valinor' ) )
	);
}
...
if ( function_exists( 'register_block_pattern' ) ) {
	function valinor_register_query_block_patterns() {
		register_block_pattern(
			'valinor/query-one',
			array(
				'title'      => esc_html__( 'Posts in a 3 column grid with post meta, author and excerpt', 'valinor' ),
	...
	add_action( 'init', 'valinor_register_query_block_patterns', 9 );
}
